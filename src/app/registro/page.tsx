...
import { signup } from '@/app/actions/auth-user'
...
export default function RegisterPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center bg-[#f4f7f6] p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-brand-secondary/20 rounded-full blur-[100px]"></div>
      ...
      <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl shadow-brand-secondary/10 w-full max-w-md relative z-10 border border-gray-100">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2 font-medium">Regístrate en COINBACA</p>
        </div>
        ...
        <form action={formAction} className="space-y-5">
          <div>
            <label htmlFor="name" className="block text-sm font-bold text-gray-700 tracking-wide mb-2">Nombre Completo</label>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500 font-medium">
            ¿Ya tienes cuenta?{' '}
            <Link href="/iniciar-sesion" className="text-green-600 font-bold hover:underline">
              Inicia Sesión
            </Link>
          </p>
        </div>
